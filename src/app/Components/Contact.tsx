    ...
    <div data-aos="fade-up" className="bg-[#121212] py-8 px-4  sm:py-16 xl:px-16  ">
      <div>
        ...
        <ul data-aos="fade-up" className=" space-y-8  md:px-4 py-16 lg:py-16">
          <li data-aos="fade-up-right" className="bg-[#121212] rounded-full w-16 h-16 lg:w-20 lg:h-20 border-2 border-purple-500 relative">
        ...
        <div data-aos="fade-up" className="flex justify-center items-center space-x-6">
         <Link  data-aos="fade-up-right"  href={"https://www.linkedin.com/in/aleeza-saleem-509b37259/"} > <  TiSocialLinkedinCircular data-aos="fade-up"size={53} className="text-neutral-600 hover:text-purple-500
          transition-all duration-200 cursor-pointer" /></Link>
        <Link  data-aos="fade-up-right"  href={"https://github.com/aleezasaleem"}>  <VscGithub data-aos="fade-up" size={40} className="text-neutral-600 hover:text-purple-500
          transition-all duration-200 cursor-pointer" /></Link>
         <Link  data-aos="fade-up-right"  href={"https://www.facebook.com/profile.php?id=100092257066326"}> <TiSocialFacebookCircular data-aos="fade-up"  size={53} className="text-neutral-600 hover:text-purple-500
          transition-all duration-200 cursor-pointer" /></Link>
