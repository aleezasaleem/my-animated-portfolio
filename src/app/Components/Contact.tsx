      ...
      <div>
        ...
        <ul data-aos="fade-up" className=" space-y-8  md:px-4 py-16 lg:py-16">
          <li className="bg-[#121212] rounded-full w-16 h-16 lg:w-20 lg:h-20 border-2 border-purple-500 relative">
            <MdEmail
              className="text-purple-500 text-3xl lg:text-5xl
          absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            ...
            <h1 className="text-white absolute transform -translate-x-1/8 -translate-y-1/2 top-1/2 -right-[460%] sm:-right-[540%] md:-right-[590%] lg:-right-[520%] text-[16px] sm:text-[19px] md:text-[21px] lg:text-[22px] ">
              {" "}
              aleezasaleem182@gmail.com
            </h1>
          </li>
          ...
          absolute transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            ...
            <h1 className="text-white absolute transform -translate-x-1/8 -translate-y-1/2 top-1/2 -right-[330%] sm:-right-[380%] md:-right-[410%] lg:-right-[370%] text-[16px] sm:text-[19px] md:text-[21px] lg:text-[22px] ">
              karachi , Pakistan
            </h1>
          </li>
        </ul>
        ...
        >
          <Link href={"https://www.linkedin.com/in/aleeza-saleem-509b37259/"}>
            {" "}
          ...
          <Link href={"https://github.com/aleezasaleem"}>
            {" "}
            <VscGithub
              data-aos="fade-up"
              size={40}
          ...
          <Link
            href={"https://www.facebook.com/profile.php?id=100092257066326"}
          >
            {" "}
